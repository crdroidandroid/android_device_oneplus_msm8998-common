...
public class SpeakerGainPreference extends Preference implements
    ...
    private void setValue(String newValue) {
        ...
        editor.putString(DeviceSettings.KEY_AUDIO_SPEAKER, newValue);
        editor.commit();
    }
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(DeviceSettings.KEY_AUDIO_SPEAKER, "0");
