...
public class HeadphoneGainPreference extends Preference implements
    ...
    public static String getValue(Context context) {
        return Utils.getFileValueDual(FILE_LEVEL, "0");
    }

    private void setValue(String newValue) {
        Utils.writeValueDual(FILE_LEVEL, newValue);
        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(getContext()).edit();
        editor.putString(DeviceSettings.KEY_AUDIO_HEADPHONE, newValue);
        editor.commit();
    }
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(DeviceSettings.KEY_AUDIO_HEADPHONE, "0");
