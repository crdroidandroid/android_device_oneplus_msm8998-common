...
public class EarpieceGainPreference extends Preference implements
    ...
    private void setValue(String newValue) {
        ...
        editor.putString(DeviceSettings.KEY_AUDIO_EAR, newValue);
        editor.commit();
    }
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(DeviceSettings.KEY_AUDIO_EAR, "0");
